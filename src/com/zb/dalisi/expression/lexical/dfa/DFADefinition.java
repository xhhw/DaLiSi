...
import static com.zb.dalisi.expression.lexical.LexicalConstants.*;
...
public class DFADefinition {
	...
	private void initStartState(){
		...
		START_STATE.setNextMidState(DOLLAR_PATTERN, ID_1);
	...
	private void initNumberStates(){
		...
		NUMBER_1.setNextMidState(LONG_PATTERN, NUMBER_7);
		NUMBER_1.setRouteToEndState(NOT_LETTER_UNDERLINE_POINT_DIGIT_PATTERN, DFAEndStateCode.NUMBER_INT_END);
		...
		NUMBER_7.setRouteToEndState(ANY_CHAR_PATTERN, DFAEndStateCode.NUMBER_LONG_END);
	}
	 ...
	 * 初始化自定义对象状态
	 */
	private void initObjectStates(){
		OBJECT_1.setNextMidState(LETTER_UNDERLINE_PATTERN, OBJECT_1);
		OBJECT_1.setNextMidState(DIGITS_PATTERN, OBJECT_1);
		OBJECT_1.setRouteToEndState(NOT_LETTER_UNDERLINE_DIGIT_PATTERN, DFAEndStateCode.OBJECT_END);
	}
	...
	private DFAMidState NUMBER_7 = new DFAMidState(DFAMidStateCode.NUMBER_7);
	...
	private DFAMidState OBJECT_1 = new DFAMidState(DFAMidStateCode.OBJECT_1);
}
